...
//    }
    ...
    public void testDecomposerLuceneDeExtended() throws Exception {
      ...
      MinimumSubtermDecomposer decomposer = new MinimumSubtermDecomposer(TermbaseImpl.fromFile(new File("src/main/resources/index-general.de.gz"),"de"));
    ...
    public void testDecomposerLuceneNlExtended() throws Exception {
      ...
      MinimumSubtermDecomposer decomposer = new MinimumSubtermDecomposer(TermbaseImpl.fromFile(new File("src/main/resources/index-general.nl.gz"),"nl"));
